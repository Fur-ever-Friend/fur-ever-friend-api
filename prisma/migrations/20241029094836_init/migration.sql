...
-- CreateTable
CREATE TABLE "petsitter_requests" (
    "id" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "petsitter_requests_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "petsitter_requests" ADD CONSTRAINT "petsitter_requests_activity_id_fkey" FOREIGN KEY ("activity_id") REFERENCES "activities"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "petsitter_requests" ADD CONSTRAINT "petsitter_requests_petsitter_id_fkey" FOREIGN KEY ("petsitter_id") REFERENCES "petsitters"("id") ON DELETE CASCADE ON UPDATE CASCADE;
